<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" fit highlight-current-row empty-text="暂无数据" @selection-change="handleSelectionChange">
      <el-table-column prop="continuous" label="连续签到"></el-table-column>
      <el-table-column prop="score" label="赠送积分"></el-table-column>
    ...
    <el-dialog :title="pushData.dialogTitle" :visible.sync="pushData.dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form :rules="rules" ref="addEditPopForm" :model="pushData" label-position="left" label-width="100px">
        <el-form-item label="连续签到" prop="continuous">
          <el-input v-model="pushData.continuous" clearable @keyup.enter.native="handleCreateSave" style="width: 30%;"></el-input>&nbsp;&nbsp;天
        </el-form-item>
        <el-form-item label="赠送积分" prop="score">
          <el-input v-model="pushData.score" clearable @keyup.enter.native="handleCreateSave" style="width: 30%;"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { fetchDataList, infoData, delData, saveData } from '@/api/apiExtUserScoreSignRule'
