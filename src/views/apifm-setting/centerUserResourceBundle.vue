  ...
  <div class="app-container">
    <div>
      ...
      <el-tag type="danger" style="margin-bottom:20px;">
        <a @click="goBuy('store_100GB')">100GB存储包(30元)</a>
      </el-tag>
      <el-tag type="danger" style="margin-bottom:20px;">
        <a @click="goBuy('store_500GB')">500GB存储包(150元)</a>
      </el-tag>
      <el-tag type="danger" style="margin-bottom:20px;">
        <a @click="goBuy('store_1T')">1TB存储包(300元)</a>
      </el-tag>
      <el-tag type="danger" style="margin-bottom:20px;">
        <a @click="goBuy('store_2T')">2TB存储包(600元)</a>
      </el-tag>
    </div>
    
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" fit highlight-current-row empty-text="暂无数据">
