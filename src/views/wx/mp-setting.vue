<template>
  <div class="app-container">
    <div class="filter-container" style="margin-top:16px;">
      <el-button class="filter-item" style="margin-bottom: 10px;margin-left: 10px;" size="small" @click="handleCreate" type="success" icon="el-icon-setting">配置 Appid / Secret</el-button>
    ...
    <el-dialog title="配置appid/secret" :visible.sync="pushData.dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form :rules="rules" ref="addEditPopForm" :model="pushData" label-position="left" label-width="160px">
        ...
        <el-form-item label=" ">
          公众号获取“secret”的时候，需要添加IP白名单，请配置: <font style="color:red;">106.14.43.122</font>
        </el-form-item>
...
<script>
import { infoData, saveData, delData, qrcode } from '@/api/centerUserSetWxMp'
