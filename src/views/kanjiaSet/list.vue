    ...
    <el-dialog :title="pushData.dialogTitle" :visible.sync="pushData.dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form :rules="rules" ref="addEditPopForm" :model="pushData" label-position="left" label-width="100px">
        ...
        <el-form-item label="原价" prop="originalPrice" >
          <el-input v-model="pushData.originalPrice" clearable @keyup.enter.native="handleCreateSave"></el-input>
        </el-form-item>
        <el-form-item label="底价" prop="minPrice" >
          <el-input v-model="pushData.minPrice" clearable @keyup.enter.native="handleCreateSave"></el-input>
        </el-form-item>
        <el-form-item label="砍价金额">
          <el-col :span="6">
            <el-form-item prop="helpPriceMin">
              <el-input v-model="pushData.helpPriceMin" clearable @keyup.enter.native="handleCreateSave"></el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2" style="text-align:center;">-</el-col>
          <el-col :span="6">
            <el-form-item prop="helpPriceMax">
              <el-input v-model="pushData.helpPriceMax" clearable @keyup.enter.native="handleCreateSave"></el-input>
            </el-form-item>
          </el-col>
