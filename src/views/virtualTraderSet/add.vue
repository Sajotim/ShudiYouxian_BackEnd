  ...
  <div class="app-container">
    <el-form :rules="rules" ref="addEditPopForm" :model="pushData" label-width="120px">
      ...
      <el-form-item label="价格" prop="price">
        <el-col :span="4">
          <el-form-item prop="price">
            <el-input v-model="pushData.price" clearable @keyup.enter.native="handleCreateSave"></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-form-item label="积分" prop="score">
        ...
        <el-col :span="20" style="color:red">&nbsp;&nbsp;&nbsp;需要消耗（扣除）用户的积分数量</el-col>
      </el-form-item>
      <el-form-item label="有效时长">
        <el-col :span="2">
          <el-form-item>
            <el-input v-model="pushData.expiresTimeout" clearable @keyup.enter.native="handleCreateSave"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="1" style="width:10px;">&nbsp;</el-col>
        <el-col :span="2">
          <el-form-item>
            <el-select v-model="pushData.expiresUnit">
        ...
        <el-col :span="18" style="color:red">&nbsp;&nbsp;&nbsp;购买后超过该时效后需要重新购买，0表示永久有效</el-col>
      </el-form-item>
      <el-form-item label="已售" prop="buyNumber">
        <el-col :span="4">
          <el-form-item prop="buyNumber">
            <el-input v-model="pushData.buyNumber" clearable @keyup.enter.native="handleCreateSave"></el-input>
          </el-form-item>
        </el-col>
