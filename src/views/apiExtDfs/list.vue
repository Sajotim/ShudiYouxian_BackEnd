<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-search" size="medium" @click="fetchData">搜索</el-button>
      <el-upload
        class="upload-demo"
        :action="uploadUrl"
        :headers="fileHeaders"
        ...
        :file-list="fileLists">
        <el-button size="small" type="success">上传本地文件</el-button>
      </el-upload>
    </div>
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" fit highlight-current-row empty-text="暂无数据" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="dateAdd" label="上传时间" />
