<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button size="medium" class="filter-item" @click="handleCreate" type="success" icon="el-icon-plus">新建模板</el-button>
    </div>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" fit highlight-current-row empty-text="暂无数据" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="快递费" align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.isFree" type="success">包邮</el-tag>
          <el-tag v-if="!scope.row.isFree" type="danger">不包邮</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="feeTypeStr" align="center" label="计价方式"/>
