  ...
  <div class="app-container">
    <el-form :rules="rules" ref="addEditPopForm" :model="pushData" label-width="120px">
      ...
      <el-form-item label="关键词" prop="keywords">
        <el-input v-model="pushData.keywords" clearable></el-input>
      </el-form-item>
      <el-form-item label="标签" prop="tags">
        <el-input v-model="pushData.tags" clearable></el-input>
      </el-form-item>
      ...
      <el-form-item label="来源" prop="income">
        <el-input v-model="pushData.income" clearable></el-input>
      </el-form-item>
      <el-form-item label="作者" prop="author">
        <el-input v-model="pushData.author" clearable></el-input>
      </el-form-item>
