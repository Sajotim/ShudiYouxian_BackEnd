<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" fit highlight-current-row empty-text="暂无数据" @selection-change="handleSelectionChange">
      <el-table-column prop="key" label="编号" width="100%"></el-table-column>
      ...
      <el-table-column prop="dateAdd" label="发布时间" width="160"></el-table-column>
      <el-table-column prop="dateUpdate" label="修改时间" width="160"></el-table-column>
...
<script>
import { fetchDataList, delData } from '@/api/apiExtPage'
